Ext.define('Ext.ux.Calculator',{
    ...
    renderTpl: [
        ...
        '<br/>',
        '<span class="{clsPrefix}-btn {clsPrefix}-sin">sin</span>',
        '<span class="{clsPrefix}-btn {clsPrefix}-cos">cos</span>',
        '<span class="{clsPrefix}-btn {clsPrefix}-tg">tan</span>',
        '<span class="{clsPrefix}-btn {clsPrefix}-ctg">rand</span>',
        '<br/>',
    ...
    doSin: function(value) {
        var me = this;
        me.value = Math.sin(Math.PI/180 * me.value).toFixed(5);
        me.numberEdit = false;
    },

    doCos: function() {
        var me = this;
        me.value = Math.cos(Math.PI/180 * me.value).toFixed(5);
        me.numberEdit = false;
    },

    doTan: function () {
        var me = this;
        me.value = Math.tan(Math.PI/180 * me.value).toFixed(5);
        me.numberEdit = false;
    },

    doRand: function () {
        var me = this;
        me.value = Math.random().toFixed(5);
        me.numberEdit = false;
    },
